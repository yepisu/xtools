...
`,init:t=>{S.setConf(t.journey),p.clear()}}},38770:function(t,e,i){i.d(e,{a:function(){return s},b:function(){return o},c:function(){return l},d:function(){return n},e:function(){return h},f:function(){return a},g:function(){return c}});var r=i(17967);let n=function(t,e){let i=t.append("rect");if(i.attr("x",e.x),i.attr("y",e.y),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("width",e.width),i.attr("height",e.height),i.attr("rx",e.rx),i.attr("ry",e.ry),"undefined"!==e.attrs&&null!==e.attrs)for(let t in e.attrs)i.attr(t,e.attrs[t]);return"undefined"!==e.class&&i.attr("class",e.class),i},s=function(t,e){n(t,{x:e.startx,y:e.starty,width:e.stopx-e.startx,height:e.stopy-e.starty,fill:e.fill,stroke:e.stroke,class:"rect"}).lower()},a=function(t,e){let i=e.text.replace(/<br\s*\/?>/gi," "),r=t.append("text");r.attr("x",e.x),r.attr("y",e.y),r.attr("class","legend"),r.style("text-anchor",e.anchor),void 0!==e.class&&r.attr("class",e.class);let n=r.append("tspan");return n.attr("x",e.x+2*e.textMargin),n.text(i),r},l=function(t,e,i,n){let s=t.append("image");s.attr("x",e),s.attr("y",i);var a=(0,r.N)(n);s.attr("xlink:href",a)},o=function(t,e,i,n){let s=t.append("use");s.attr("x",e),s.attr("y",i);let a=(0,r.N)(n);s.attr("xlink:href","#"+a)},c=function(){return{x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}},h=function(){return{x:0,y:0,width:100,height:100,fill:void 0,anchor:void 0,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0,valign:void 0}}}}]);